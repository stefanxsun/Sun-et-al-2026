function [varargout] = VEHA_L7_Grating_PlotLFPPower_SFrCtrSSz(sCFG)
...
chDestMetaFolder = 'VEHA_L7_Grating_PlotLFPPower_SFrCtrSSz';
...
chDestFile_Fig = 'VEHA_L7_Grating_PlotLFPPower_SFrCtrSSz.fig';
chDestFile_Mat = 'VEHA_L7_Grating_PlotLFPPower_SFrCtrSSz.mat';
...
if blDoProc
    ...
    LocThreshhold = sINPUT_1.sL5G_MDS.sPRES.sPARAM.StimulusDuration   * inSampleRate *0.95; %%%% arbitrary threshholding Stefan 2022/11
    QuiThreshhold  = sINPUT_1.sL5G_MDS.sPRES.sPARAM.StimulusDuration   * inSampleRate *0.05;
