function [dbXPhaseRandMat, db1Alpha, hFIG] = NS_ColoredNoiseMatchingRandSeries(dbXMat, inDim, inNSmpOut, inNSmpFit, blFig)
%DBXPHASERANDMAT = NS_ColoredNoiseMatchingRandSeries(DBXMAT, INDIM,
...
%along dimension INDIM. Based on NS_PhaseRandomize1D.
