function dbXPhaseRandMat = NS_PowerMatchingRandSeries(dbXMat, inDim, inNSmpOut)
%DBXPHASERANDMAT = NS_PowerMatchingRandSeries(DBXMAT, INDIM, INNSMPOUT)
