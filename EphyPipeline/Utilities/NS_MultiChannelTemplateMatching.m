function db1Score = NS_MultiChannelTemplateMatching(db2Signal, db2Template, blCenter, blNormalize)
%Synopsis: DB1SCORE = NS_MultiChannelTemplateMatching(DB2SIGNAL, DB2TEMPLATE, [BLNORM])
