...
for iBnd = 1:length(cBAND)
    ...
    for iCt = 1:4
        for iSF = 1:4
            ...
            for iSz = 1:4
                ...
                permuteP(iCnd) = permutationTest(db1LastDay, db1FirstDay, 1,'sidedness','larger','exact',1);
    ...
    sgtitle(sprintf('%s Power', cBAND{iBnd}));
    linkaxes(hAX);
    ...
    for iCt = 1:4
        for iSF = 1:4
            ...
            for iSz = 1:4
                ...
                %%%%%%%%%%%  stefan added observeddifference and effect
                %%%%%%%%%%%  size as output to report in stats table,
                %%%%%%%%%%%  03/04/2025
                [ZpermuteP(iCnd),o(iCnd),e(iCnd),ci(iCnd,:)] = permutationTest_Stefan(db1LastDay, db1FirstDay, 1,'sidedness','larger','exact',1);
