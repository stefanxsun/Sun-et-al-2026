function db1Score = NS_MultiChannelTemplateMatching_2(db2Signal, db2Template, blCenter, blNormalize)
%Synopsis: DB1SCORE = NS_MultiChannelTemplateMatching_2(DB2SIGNAL, DB2TEMPLATE, [BLNORM])
