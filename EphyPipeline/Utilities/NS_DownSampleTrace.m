function db1OutputTrace = NS_DownSampleTrace(db1InputTrace, inDownSamplingFactor, varargin)
%DB1OUTPUTTRACE = NS_DownSampleTrace(DB1INPUTTRACE, INDOWNSAMPLINGFACTOR,[INTYPE])
%
