function NS_SaveFig(chPath, hFIG, cFIGNAME, chOption)
% Utility to save figures. Save figures in the handle vector hFIG in the folder
% provided by chPath under the names provided in the cell array cFIGNAME; By
% default a .eps, .png and .pdf files are saved.  This can be controled by the
% option string chOption. To save only .png and .pdf. Set chOption to 'pngpdf'.
% The routine requires exportfig from the file exchange.
