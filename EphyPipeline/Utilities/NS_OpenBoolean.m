function bl1Output = NS_OpenBoolean(bl1Input, in1Order)
%BL1OUTPUT = NS_OPENBOOLEAN(BL1INPUT, IN1ORDER) performs a morphological
%opening of order IN1ORDER (IN1ORDER erosions followed by IN1ORDER
%dilations) on the vector BL1INPUT and returns the result in BL1OUTPUT
